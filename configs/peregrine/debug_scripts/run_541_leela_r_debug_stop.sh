#!/usr/bin/env bash
# Run 541.leela_r under gem5 (peregrine, --fast-only) and stop when guest stdout
# (stdout.txt under --outdir) contains "4002 visits, 15054 nodes" (end of first
# UCT search / first move on current test.sgf + seed).
# Then print the last committed-instruction progress line from gem5_stdout.log.
#
# Layout: configs/peregrine/debug_outputs/m5out_541.leela_r/{gem5_stdout.log,stdout.txt,...}
#
...
STOP_LINE='4002 visits, 15054 nodes'
