#!/usr/bin/env bash
# Run 505.mcf_r under gem5 (peregrine, --fast-only) and stop when guest stdout
# (stdout.txt under --outdir) contains "starting primal_net_simplex".
# Then print the last committed-instruction progress line from gem5_stdout.log.
#
# Layout: configs/peregrine/debug_outputs/m5out_505.mcf_r/{gem5_stdout.log,stdout.txt,...}
#
...
STOP_LINE='starting primal_net_simplex'
